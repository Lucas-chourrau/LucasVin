...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220314_vin2_ffe66b9f3afc024d1420_20220323154325_archive.zip';
	const ARCHIVE_SIZE		 = '84841758';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ffe66b9-23154325';
    const SECONDARY_PACKAGE_HASH = 'b39477c-23154325';
	const VERSION			 = '1.4.4';
